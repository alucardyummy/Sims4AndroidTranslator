...
source.include_patterns = templates/*.html,packer/*.py,singletons/*.py,singletons/*.json,android/network_security_config.xml
version = 1.1
...
android.network_security_config = android/network_security_config.xml
